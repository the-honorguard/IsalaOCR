...
from .cli import _locator_settings
...
from .training.table_cell_ground_truth import ensure_table_cell_ground_truth, sync_canonical_detection_gate
...
def _collect_mapping(args: argparse.Namespace, original_argv: list[str]) -> int:
    ...
    state = sync_canonical_detection_gate(workspace)
