                ...
                if source_registry.is_dir() and not target_registry.exists():
                    ...
                    if active_meta.is_file():
                        try:
                            ...
                            pass
                source_active = models / "projects" / duplicate_from / "active-recognition"
                target_active = models / "projects" / context.project_id / "active-recognition"
    ...
    def retry_job(job_id: str):
        ...
        if job_type == "artifact_delete":
            ...
            payload={"job_id":new_job_id,"job_type":"artifact_delete","action_id":"",
                     ...
                     "progress_label":"Verwijderen in wachtrij","created_at":_utcnow(),"updated_at":_utcnow(),
                     "retried_from":job_id}
        else:
            ...
            payload={"job_id":new_job_id,"action_id":action_id,"action_name":ACTIONS[action_id],
                     ...
                     "project_name":str(old.get("project_name") or project_manager.active().name),
                     "options":options,"status":"pending","progress_percent":0,"progress_mode":"indeterminate",
                     "progress_label":"In wachtrij","created_at":_utcnow(),"updated_at":_utcnow(),
                     "retried_from":job_id}
