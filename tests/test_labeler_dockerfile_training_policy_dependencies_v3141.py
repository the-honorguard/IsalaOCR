...
def test_labeler_image_includes_training_policy_modules_and_pillow() -> None:
    ...
    assert "COPY application/src/isala_ocr/training/table_model_evaluation_policy.py" in dockerfile
    assert "COPY application/src/isala_ocr/training/table_hard_negative_policy.py" in dockerfile
